...
%%%%        EC1 - 2020 - T...... (1, 2 OU 3)
%%%%
%%%%    NUSP1 BELTRANO de Tal (Substitua pelos num. e nomes corretos em ordem alf.)
%%%%    NUSP2 FULANO de Tal  (Use espaços em branco se não houver 2o. e 3o.)
%%%%    NUSP3 SICRANO de Tal
